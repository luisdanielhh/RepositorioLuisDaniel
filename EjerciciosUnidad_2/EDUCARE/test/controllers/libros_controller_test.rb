...
class LibrosControllerTest < ActionController::TestCase
  ...
  test "should create libro" do
    assert_difference('Libro.count') do
      post :create, libro: { autor: @libro.autor, editorial_id: @libro.editorial_id, genero_id: @libro.genero_id, num_ejemplar: @libro.num_ejemplar, reseña: @libro.reseña, titulo: @libro.titulo }
    end
  ...
  test "should update libro" do
    patch :update, id: @libro, libro: { autor: @libro.autor, editorial_id: @libro.editorial_id, genero_id: @libro.genero_id, num_ejemplar: @libro.num_ejemplar, reseña: @libro.reseña, titulo: @libro.titulo }
    assert_redirected_to libro_path(assigns(:libro))
  end
